...
(function() {
  ...
  ColorScheme = (function() {
    ...
    ColorScheme.prototype.colors = function() {
      var dispatch, h, i, j, m, n, output, ref1, ref2, used_colors;
      used_colors = 1;
      ...
      for (i = m = 0, ref1 = used_colors - 1; 0 <= ref1 ? m <= ref1 : m >= ref1; i = 0 <= ref1 ? ++m : --m) {
        for (j = n = 0; n <= 3; j = ++n) {
          output[i * 4 + j] = ((ref2 = this.options.includeHash) != null ? ref2 : {
            '#': ''
          }) + this.col[i].get_hex(this._web_safe, j);
        }
      }
      return output;
    };
    ...
    ColorScheme.prototype.from_hex = function(hex) {
      var b, c, g, h, h0, h1, h2, hsv, hsv1, i, i1, i2, k, num, r, ref1, ref2, rgbcap, s, v, wheelKeys;
      if (hex == null) {
      ...
      v = null;
      wheelKeys = [];
      ref2 = ColorScheme.COLOR_WHEEL;
      for (i in ref2) {
        if (!hasProp.call(ref2, i)) continue;
        wheelKeys.push(i);
      }
